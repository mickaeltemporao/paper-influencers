...
task_dict = {
    "type":"""
        ...
        Your task is to classify the account into one of the following categories:
        
        - News media (providers of informational content and analysis on politics, current affairs in France and internationally);
        - Political Actors (formal or officially registered candidates, elected politicians and organizations that compete in elections, official spokespersons and members of French government);
        - Other (other persons and organizations of interest are all other accounts that are for individuals or personal use)

        For each of these categories, I have provided a short description to help you with your classification. 
        Your output should consist solely of the selected category, that is the exact text before the parathenesis.
    """,
